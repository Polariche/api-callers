...
[ -z ${secret} ] && secret=qouriers-km-secret
[ -z ${namespace} ] && namespace=qouriers
[ -z ${webhookDeployment} ] && webhookDeployment=qourier-key-manager
[ -z ${webhookName} ] && webhookName=key-manager.qouriers.io
[ -z ${service} ] && service=qourier-key-manager
